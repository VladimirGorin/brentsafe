...
async function start() {
    ...
    let getPriceEuro = await send_request("post", false, "transaction-convert-euro", {price: priceBitcoin.price_euro, sicret_key:sicret_key})

    await setElements(priceBitcoin.price_euro, String(getPriceEuro.price).substr(0, 8))
